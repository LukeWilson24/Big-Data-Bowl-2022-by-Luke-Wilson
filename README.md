...
GitHub does not support the much of the data because the files are too big. Therefore, I have not included any of the data provided to me through the Big Data Bowl Competition.
